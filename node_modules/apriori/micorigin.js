        ...
        var ArrayUtils = (function() {
            ...
            ArrayUtils.toFixedSizeJoinedSets = function(itemSets, length) {
                ...
                for(var j = 0; j < oneItemArray.length; j++){
                    ...
                    // }
                    if(count >= length -1){
                        calcutedItems.push(oneItemArray[j].toString());
                    }
                    else{
                ...
                for(var s = 0; s < itemSets.length; s++){
                    ...
                    var itemDiff = _.difference(calcutedItems, itemSetA);
                    console.log(oneItemArray, "oneItemArray");
                    console.log(itemSetA, "itemSetA");
                    console.log(itemDiff, "diff");
                    for(var q = 0; q < itemDiff.length; q++){
                        var itemSetB = calcutedItems[q];
                        var mergedArray = [].concat(itemSetA).concat(itemSetB);
                        joinedSetArray.push(mergedArray);
                    }
